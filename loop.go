...
// type loop struct {
// 	vi []uint32 //an ordered list of vertex indices - that form a closed loop
// }

// func NewLoop() *loop {
// 	return &loop{vi: []uint32{}}
// }

// func (l *loop) debugMesh(model *landMesh, ctn *vec3, debugMesh *landMesh) *landMesh {
...
// func (loop *loop) triangulate(dbm *landMesh, m *landMesh, ctn *vec3) []uint32 {
...
// func (loop *loop) addVert(m *landMesh, vi uint32) {
...
// func (l *loop) isEarEmpty(bi int, m *landMesh) bool {
...
// func (l *loop) findAndRemoveEar(m *landMesh, ctn *vec3) (face []uint32) {
